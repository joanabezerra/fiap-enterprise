...
class CarrinhoComprasDAOTest {
	...
	void test() {
		...
		Fornecedor f1 = new Fornecedor("Nike", "123123123");
		Fornecedor f2 = new Fornecedor("Adidas", "987654321");
		
		List<Fornecedor> fornecedores = new ArrayList<>();
		fornecedores.add(f1);
		fornecedores.add(f2);
		
		Produto produto1 = new Produto(fornecedores, "Chuteira", 200);
		Produto produto2 = new Produto(fornecedores, "Luva", 80);
